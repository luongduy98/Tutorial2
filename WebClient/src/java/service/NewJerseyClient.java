...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/WebServiceREST/webresources";

    public NewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.users.entity.users");
    }
    ...
    public String checkLogin(String password, String username) throws ClientErrorException {
        WebTarget resource = webTarget;
        if (password != null) {
